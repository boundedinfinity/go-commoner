...
func Test_FoldLeft_sameType(t *testing.T) {
	...
	actual := slices.FoldLeft(0, input, func(v int, a int) int {
		return a + v
	})
...
func Test_FoldLeft_diffType(t *testing.T) {
	...
	actual := slices.FoldLeft(0, input, func(v int, a byte) int {
		if v == 0 {
			return int(a)
		} else {
			return v
...
func Test_FoldRight_diffType(t *testing.T) {
	...
	actual := slices.FoldRight(0, input, func(v int, a byte) int {
		if v == 0 {
			return int(a)
		} else {
			return v
