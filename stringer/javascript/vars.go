...
import (
	...
	stringer "github.com/boundedinfinity/go-commoner/stringer"
)
...
func init() {
	valid_first_chars = append(valid_first_chars, stringer.UppercaseLetters...)
	valid_first_chars = append(valid_first_chars, stringer.LowercaseLetters...)
	...
	valid_nonfirst_chars = append(valid_nonfirst_chars, stringer.Numbers...)
}
