...
func DegreeToRadian[T mather.Number](x T) T {
	return T(float64(x) * math.Pi / 180)
}

// https://byjus.com/degree-and-radian-measure-formula/
func RadianToDegree[T mather.Number](x T) T {
	return T(float64(x) * 180 / math.Pi)
}

// https://byjus.com/degree-and-radian-measure-formula/
func ArcLengthRadiusToRadian[T mather.Number](arcLength, radius T) T {
...
func ArcCosine[N mather.Number](x N) N {
...
func InverseHyperbolicCosine[N mather.Number](x N) N {
...
func ArcSine[N mather.Number](x N) N {
...
func InverseHyperbolicSine[N mather.Number](x N) N {
...
//	ArcTangent(±0) = ±0
//	ArcTangent(±Inf) = ±Pi/2
func ArcTangent[N mather.Number](x N) N {
...
//	ArcTangent2(-Inf, x) = -Pi/2
func ArcTangent2[N mather.Number](y, x N) N {
...
func InverseHyperbolicTangent[N mather.Number](x N) N {
...
//	Cosine(±Inf) = NaN
//	Cosine(NaN) = NaN
func Cosine[N mather.Number](x N) N {
...
func HyperbolicCosine[N mather.Number](x N) N {
...
//	Sine(±Inf) = NaN
//	Sine(NaN) = NaN
func Sine[N mather.Number](x N) N {
...
//	Sincos(±Inf) = NaN, NaN
//	Sincos(NaN) = NaN, NaN
func Sincos[N mather.Number](x N) (N, N) {
...
func HyperbolicSine[N mather.Number](x N) N {
...
//	Tangent(±Inf) = NaN
//	Tangent(NaN) = NaN
func Tangent[N mather.Number](x N) N {
...
func HyperbolicTan[N mather.Number](x N) N {
